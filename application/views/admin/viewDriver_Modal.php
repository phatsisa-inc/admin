<div id="viewDriver_Modal" role="dialog" tabindex="-1" class="modal fade">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document"> 
        <div class="modal-content">
            <form method="post"> 
                <div class="modal-header">
                    <h4 class="modal-title">Driver View</h4>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group"><label>Status*</label><input id="status" name="status" class="form-control" type="text" /></div>
                        </div>
                        <div class="col-6">
                            <div class="form-group"><label>Password*</label><input id="password" name="text" type="text" class="form-control" /></div>
