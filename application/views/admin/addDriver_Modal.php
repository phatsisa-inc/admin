<div id="addDriver_Modal" role="dialog" tabindex="-1" class="modal fade">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <form method="post" id="driver_form"> 
                <div class="modal-header">
                    <h4 class="modal-title">Add Driver</h4><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group"><label>Firstname*</label><input id="usr_fname" name="usr_fname" type="text" class="form-control" required/></div>
                            <div class="form-group"><label>Lastname*</label><input id="usr_lname" name="usr_lname" type="text" class="form-control" required/></div>
                            <div class="form-group"><label>Email*</label><input id="usr_email" name="usr_email" type="email" class="form-control" required/></div>
                            <div class="form-group"><label>Phone number*</label><input id="usr_phone" name="usr_phone" class="form-control" type="number" required/></div>
                        </div>                    
                        <div class="col-6">
